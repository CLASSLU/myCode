...
public class FileMD5 {
	...
	public static void main(String[] args) throws IOException {
		...
		//File big = new File("E:\\gxshw\\ETS\\src\\com\\sdjxd\\util\\FileMD5.java");
		File big = new File("C:\\Users\\Administrator\\Desktop\\导入excel.docx");
	...
	public static String getFileMD5String(FileInputStream in,int size) throws IOException {
		...
		MappedByteBuffer byteBuffer = ch.map(FileChannel.MapMode.READ_ONLY,
				startPosition, size - startPosition);
		messageDigest.update(byteBuffer);
