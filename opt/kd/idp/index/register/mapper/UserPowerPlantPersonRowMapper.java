...
public class UserPowerPlantPersonRowMapper implements RowMapper<UserPowerPlantPersonBean>{
	
	private SimpleDateFormat sdf = null;
	
	public UserPowerPlantPersonRowMapper() {
		sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	}
	
	public UserPowerPlantPersonRowMapper(String pattern) {
	...
	public UserPowerPlantPersonBean mapRow(ResultSet rs, int rowNum) throws SQLException {

		UserPowerPlantPersonBean user= new UserPowerPlantPersonBean();
